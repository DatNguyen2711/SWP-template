                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body">
                                                <div style="text-align: center;">
                                                    <a href="editMyStudentAvatar?username=${account.getUsername()}">Change Avatar</a><br>
                                                    <a href="editMyStudentProfile?username=${account.getUsername()}">Edit</a><br>
