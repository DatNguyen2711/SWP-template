<%-- 
    ...
    Created on : Feb 7, 2023, 11:22:05 AM
    Author     : datla
--%>
                        ...
                        <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="./Views/course-archive.jsp">Course Archive</a></li>                
                                    <li><a href="Testcourse">Course Detail</a></li>                
                                </ul>
                            </li>           
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="./Views/course-archive.jsp">Blog Archive</a></li>                
                                    <li><a href="./Views/course-detail.jsp">Blog Single</a></li>                
                                </ul>
                            </li>            
