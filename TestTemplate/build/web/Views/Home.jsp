<%-- 
    Document   : Home.jsp
    Created on : Feb 7, 2023, 11:21:17 AM
    Author     : datla
--%>
  ...
  <section id="mu-slider">
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="/Views/assets/img/slider/1.jpg" alt="img">
        </figure>
      </div>
    ...
    <div class="mu-slider-single">
      <div class="mu-slider-img">
        <figure>
          <img src="./Views/assets/img/slider/3.jpg" alt="img">
        </figure>
          <figure>
          <img src="./Views/assets/img/slider/3.jpg" alt="img">
          </figure><!-- comment -->
      ...
      <div class="mu-slider-content">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
            Dolor amet error eius reiciendis eum sint unde eveniet deser
            unt est debitis corporis temporibus recusandae accusamus.</p>
        <a href="#" class="mu-read-more-btn">Read More</a>
      </div>
    </div>
    <!-- Start single slider item -->    
