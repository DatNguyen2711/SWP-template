...
<html>
    ...
    <body>
        <form action="/TestFontend/load" method="post">
            ...
            <a onclick="loadMore()" class="add">Add</a>
            <button class="bttn-simple bttn-md bttn-primary" type="submit" onclick="GetNum()" >Submit</button>
            <input name="number" hidden id="num"/>
        </form>
        <p class="animate__animated animate__zoomIn">${ss}</p>
        ...
        <script>
            ...
            function GetNum() {
                ...
                document.getE l em e ntById("num").value = ee;
            }
            ...
            function loadMore() {
                ...
                a.innerHTML = "<div id=\"question\" class=\"question\">\n" + "                <div class=\"content-question\">\n" +
                        ...
                        "                              <a  c lass=\"add1\" onclick=\"loadMoreAns(this)\">+</a>\n" +
                        "                            <input type=\"text\" name=\"answer\"/> \n" +
                        "                            <input name=\"correctAns\" class=\"checkbox\" value=\"1\" type=\"checkbox\"/>\n" +
                        "                            <!--<div id=\"answer1\"></div>-->\n" +
                        "                        </div>\n" +
